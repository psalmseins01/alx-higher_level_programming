...
This project was done as part of the requirements for **ALX Full Stack Software Engineering Course**
The aim of the project is to learn about doctrings
To create and implement tests using **python**


## Technologies
* Python Scripts are written with `Python`
* C files are compiled by `gcc `
* Tested on Ubuntu linux OS
