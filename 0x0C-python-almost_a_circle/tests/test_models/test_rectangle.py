...
class TestRectangle_area(unittest.TestCase):
    ...
    def test_area_small(self):
        ...
        self.assertEqual(20, rt.area())

    def test_area_large(self):
        rt = Rectangle(999999999999999, 999999999999999999, 0, 0, 1)
        self.assertEqual(999999999999998999000000000000001, rt.area())
...
class TestRectangle_stdout(unittest.TestCase):
    ...
    def capture_stdout(rect, method):
        """Captures and returns text to stdout.

        Args:
            rect: The Rectangle to stdout.
    ...
    def test_str_method_changed_attributes(self):
        ...
        r.width, r.height = 15, 1
        r.x, r.y = 8, 10
        self.assertEqual("[Rectangle] ([4]) 8/10 - 15/1", str(r))

    def test_str_method_one_arg(self):
        with self.assertRaises(TypeError):
            Rectangle(1, 2, 3, 4, 5).__str__(1)
...
class TestRectangle_update_args(unittest.TestCase):
    """Unittest testing update args method of the Rectangle class."""
...
class TestRectangle_update_kwargs(unittest.TestCase):
    """Unittest update kwargs method of the Rectangle class."""
...
class TestRectangle_to_dictionary(unittest.TestCase):
    """Unittests to_dictionary method of the Rectangle class."""

    def test_to_dictionary_output(self):
        rec = Rectangle(11, 2, 1, 9, 5)
        correct = {'x': 1, 'y': 9, 'id': 5, 'height': 2, 'width': 11}
        self.assertDictEqual(correct, rec.to_dictionary())

    def test_to_dictionary_no_object_changes(self):
        rec1 = Rectangle(11, 2, 1, 9, 5)
        rec2 = Rectangle(5, 9, 1, 2, 11)
